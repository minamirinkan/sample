...
export const mockStudents = [
    { id: 1, code: '20230001', lastName: '山田', firstName: '太郎', kana: 'ヤマダ タロウ', grade: '既卒生', entryDate: '2024/04/01', billingStatus: '作成済' },
    ...
    { id: 4, code: '20230004', lastName: '高橋', firstName: '優子', kana: 'タカハシ ユウコ', grade: '小学2年', entryDate: '2024/05/01', billingStatus: '未請求' },
    { id: 5, code: '20230005', lastName: '伊藤', firstName: '健太', kana: 'イトウ ケンタ', grade: '小学3年', entryDate: '2024/05/01', billingStatus: '作成済' },
    { id: 6, code: '20230006', lastName: '渡辺', firstName: '美咲', kana: 'ワタナベ ミサキ', grade: '小学4年', entryDate: '2024/05/15', billingStatus: '未請求' },
    { id: 7, code: '20230007', lastName: '中村', firstName: '大翔', kana: 'ナカムラ ヒロト', grade: '小学5年', entryDate: '2024/04/10', billingStatus: '作成済' },
    ...
    { id: 10, code: '20230010', lastName: '吉田', firstName: '葵', kana: 'ヨシダ アオイ', grade: '小学6年', entryDate: '2024/06/05', billingStatus: '未請求' },
    { id: 11, code: '20230011', lastName: '山本', firstName: '颯太', kana: 'ヤマモト ソウタ', grade: '高校2年', entryDate: '2024/06/10', billingStatus: '作成済' },
    { id: 12, code: '20230012', lastName: '斎藤', firstName: '楓', kana: 'サイトウ カエデ', grade: '高校1年', entryDate: '2024/06/15', billingStatus: '未請求' },
    { id: 13, code: '20230013', lastName: '松本', firstName: '海翔', kana: 'マツモト カイト', grade: '高校3年', entryDate: '2024/07/01', billingStatus: '作成済' },
