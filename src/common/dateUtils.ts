...
export const getWeekdayIndex = (selectedDate: SelectedDate): number =>{
...
export const getDateKey = (selectedDate: SelectedDate): string =>{
  return `${selectedDate.year}-${String(selectedDate.month).padStart(2, '0')}-${String(selectedDate.date).padStart(2, '0')}`;
};

export const formatDateDisplay = (selectedDate: SelectedDate): string =>{
...
export const getYearMonthKey = (selectedDate: SelectedDate): string =>{
...
export const getPreviousYearMonth = (ymKey: string): string | null =>{
 ...
 */
export const getDayOfWeekFromDateStr = (dateStr: string): number => {
